...
def normal_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('C:/Users/marin/OneDrive/Рабочий стол/куку/MatStat-main/Lab1-4/Res' +'Normal distribution ' + str(size) +".png")
...
def cauchy_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('C:/Users/marin/OneDrive/Рабочий стол/куку/MatStat-main/Lab1-4/Res' +'Cauchy distribution ' + str(size) +".png")
    return
...
def poisson_distribution():
    for size in sizes:
        ...
        plt.show()
        fig.savefig('C:/Users/marin/OneDrive/Рабочий стол/куку/MatStat-main/Lab1-4/Res' +'Poisson distribution ' + str(size) +".png")
    return
...
def uniform_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('C:/Users/marin/OneDrive/Рабочий стол/куку/MatStat-main/Lab1-4/Res' +'Uniform distribution ' + str(size) +".png")
    return
